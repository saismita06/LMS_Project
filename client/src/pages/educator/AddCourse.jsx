...
const AddCourse = () => {
  ...
  // ✅ FIXED: Using the custom hook instead of useContext(AppContext)
  ...
  // ... (handleChapter and handleLecture functions stay the same)
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      if (!image) {
        return toast.error('Thumbnail Not Selected'); // Added return to stop execution
      }
  ...
  return (
    // ... Your existing JSX (rest of the return block)
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
       {/* (Keep your form and JSX exactly as it was) */}
       <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
         ...
         {/* (Rest of your JSX for Chapters and Popup...) */}
         <div>
